...
export namespace Prisma {
  ...
  */
  ...
  type GetAppGroupByPayload<T extends AppGroupByArgs> = Promise<
    Array<
  ...
  export type appGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof app ?app [P]
  : 
     never
  } 
    : app
  ...
  export interface appDelegate<GlobalRejectSettings> {
    ...
    **/
     ...
     * 
     * // Only select the `branchName`
     * const appWithBranchNameOnly = await prisma.app.findMany({ select: { branchName: true } })
     * 
    **/
    ...
    **/
    ...
    >(args: SubsetIntersection<T, AppGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetAppGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type appScalarWhereWithAggregatesInput = {
    ...
    monoAppId?: StringWithAggregatesFilter | string
  ...
  export type appUpdateInput = {
    ...
    monoAppId?: StringFieldUpdateOperationsInput | string
